...
def convert(inputPath, outputPath, frameProcessor, frameShape=None, fps=None):
    '''
    ...
    while input_video.isOpened():
        ...
        if output_video is None:
            ...
            if frameShape is None:
                ...
                output_video = cv2.VideoWriter(outputPath, fourcc, fps, frameShape)
        count += 1
        try:
...
if __name__ == "__main__":
    ...
    save_video_frames(video, "project_video/")
